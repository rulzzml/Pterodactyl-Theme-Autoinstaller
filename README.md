...
```bash
bash <(curl -s https://raw.githubusercontent.com/rulzzml/Pterodactyl-Theme-Autoinstaller/main/install.sh)
```
...
- Uninstall Tema
 ...
 (Kode Token : pm wa.me/6285133225756)
...
## Credits 
- Recode 2 By [ Rulzz ] (https://github.com/RulzzML)
